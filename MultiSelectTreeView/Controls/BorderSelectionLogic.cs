...
namespace System.Windows.Controls
{
    internal class BorderSelectionLogic : IDisposable
    {
        ...
        public BorderSelectionLogic(MultiSelectTreeView treeView, Border selectionBorder,
            ScrollViewer scrollViewer, ItemsPresenter content, IEnumerable<MultiSelectTreeViewItem> items)
        {
            if (treeView == null)
            {
        ...
        private void OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            MouseParseMove(e, width, height);
        }

        private void MouseParseMove(MouseEventArgs e, double width, double height)
        {
            Point currentPoint = Mouse.GetPosition(content);
